...
public class ServletAnnotationFinderTest extends PlexusTestCase {
    public void testFindServletEmptyPath() throws Exception {
        ServletAnnotationFinder servletAnnotationFinder = (ServletAnnotationFinder) lookup(
                ServletAnnotationFinder.class.getName());
        Set<ServletDescriptor> servletDescriptors = servletAnnotationFinder
                .findServlets("org.codehaus.mojo.gwt", null,
    ...
    public void testFindServletWithPath() throws Exception {
        ServletAnnotationFinder servletAnnotationFinder = (ServletAnnotationFinder) lookup(
                ServletAnnotationFinder.class.getName());
        Set<ServletDescriptor> servletDescriptors = servletAnnotationFinder
                .findServlets("org.codehaus.mojo.gwt", "foo",
                        Thread.currentThread().getContextClassLoader());

...
public class MergeWebXmlMojo extends AbstractGwtWebMojo {
    ...
    public void doExecute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            for (String module : getModules()) {
                ...
                Map<String, String> moduleServlets =
                        isWebXmlServletPathAsIs() ? gwtModule.getServlets("") : gwtModule.getServlets();
                ...
                if (scanRemoteServiceRelativePathAnnotation && packageNamePerModule != null) {
                    ...
                    if (StringUtils.isNotBlank(packageName)) {
                        ...
                        Set<ServletDescriptor> annotatedServlets = servletAnnotationFinder.findServlets(
                                packageName,
                                isWebXmlServletPathAsIs() ? null : gwtModule.getPath(),
    ...
    private ClassLoader getAnnotationSearchClassLoader() throws MalformedURLException {
        ...
        return new URLClassLoader(new URL[] {
            new File(getProject().getBuild().getOutputDirectory()).toURI().toURL()
        });
    }
}

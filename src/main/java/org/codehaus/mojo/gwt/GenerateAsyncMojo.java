...
public class GenerateAsyncMojo extends AbstractGwtMojo {
    ...
    private void generateAsync(JavaClass clazz, File targetFile) throws IOException {
        PrintWriter writer = new PrintWriter(
                new BufferedWriter(new OutputStreamWriter(buildContext.newFileOutputStream(targetFile), encoding)));
        ...
        for (JavaMethod method : methods) {
            ...
            if (deprecated) writer.println("     * @deprecated");
            writer.println("     */");
            if (deprecated) writer.println("    @Deprecated");
            if (returnRequest) {
            ...
            if (method.getReturnType().isVoid()) {
                ...
                if (method.getReturnType().getDimensions()
                        != method.getReturnType(true).getDimensions()) {
        ...
        if (clazz != null && clazz.getAnnotations() != null) {
            for (Annotation annotation : clazz.getAnnotations()) {
                ...
                if (annotation
                        .getType()
                        .getValue()
                        .equals("com.google.gwt.user.client.rpc.RemoteServiceRelativePath")) {

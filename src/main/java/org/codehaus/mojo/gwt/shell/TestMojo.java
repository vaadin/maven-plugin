...
public class TestMojo extends AbstractGwtShellMojo {
    ...
    private void forkToRunTest(String test) throws MojoExecutionException {
        ...
        try {
            ...
            try {
                ...
                cmd.arg(test);
                cmd.systemProperty("surefire.reports",
    ...
    protected String getGwtArgs() {
        ...
        sb.append(
                checkAssertions ? " -checkAssertions" : " -nocheckAssertions");
        sb.append(clusterFunctions ? " -XclusterFunctions"
                : " -XnoclusterFunctions");
        sb.append(disableCastChecking ? " -XnocheckCasts" : " -XcheckCasts");
        sb.append(disableClassMetadata ? " -XnoclassMetadata"
                : " -XclassMetadata");
        sb.append(disableRunAsync ? " -XnocodeSplitting" : " -XcodeSplitting");
        sb.append(draftCompile ? " -draftCompile" : " -nodraftCompile");
        sb.append(inlineLiteralParameters ? " -XinlineLiteralParameters"
                : " -XnoinlineLiteralParameters");
        sb.append(optimizeDataflow ? " -XoptimizeDataflow"
                : " -XnooptimizeDataflow");
        sb.append(ordinalizeEnums ? " -XordinalizeEnums"
                : " -XnoordinalizeEnums");
        sb.append(removeDuplicateFunctions ? " -XremoveDuplicateFunctions"
    ...
    private File getClassPathElementFor(Class<?> clazz) {
        ...
        getLog().debug("getClassPathElementFor " + clazz.getName() + " file "
                + url.toString());

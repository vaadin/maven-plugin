...
public class RunMojo extends AbstractGwtWebMojo {
    ...
    public void doExecute() throws MojoExecutionException, MojoFailureException {
        JavaCommand cmd = createJavaCommand().setMainClass("com.google.gwt.dev.DevMode");
        ...
        if (isAppEngine) {
            ...
            if (appEngineHome.exists()
                ...
                try {
                    ...
                    appEngineToolsApi = new File(
                            appEngineHome, "appengine-java-sdk-" + appEngineVersion + "/lib/appengine-tools-api.jar");
                    ...
                    appEngineLocalRuntime = new File(
                            appEngineHome,
                            "appengine-java-sdk-" + appEngineVersion + "/lib/impl/appengine-local-runtime.jar");
                    ...
                    appEngineAgent = new File(
                            appEngineHome, "appengine-java-sdk-" + appEngineVersion + "/lib/agent/appengine-agent.jar");
                    classPath.add(appEngineAgent);
